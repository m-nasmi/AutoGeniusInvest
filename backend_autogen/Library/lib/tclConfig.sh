...
# installed.
TCL_PREFIX='D:/My Projects/autogenius_invest/backend_autogen\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/My Projects/autogenius_invest/backend_autogen\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/My Projects/autogenius_invest/backend_autogen\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/My Projects/autogenius_invest/backend_autogen\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/My Projects/autogenius_invest/backend_autogen\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/My Projects/autogenius_invest/backend_autogen\Library\lib\tclstub86.lib'
